...
* @param angle size of interior angles in degrees, where 0 < angle < 180
  ...
  */
  ...
  /**
     ...
     * 
     * (0,0) is the lower-left corner of the polygon; 
use only right-hand turns to draw.
     * 
     * @param turtle the turtle context
 ...
 * towards the target point.
     * 
     * The return value is the angle input to turn() that would point the turtle in the direction
 of
 ...
 *         must be 0 <= angle < 360
     */
    public static double calculateHeadingToPoint(double currentHeading, int currentX,
 int currentY,
